...
const Hyperspeed = memo(({
  ...
  // Memoize distortion configurations to prevent recreation
  ...
  useEffect(() => {
    ...
    class App {
      constructor(container, options = {}) {
        ...
        // Get container dimensions, fallback to window if container has no size
        const width = container.offsetWidth || container.clientWidth || window.innerWidth;
        const height = container.offsetHeight || container.clientHeight || window.innerHeight;
      ...
      onWindowResize() {
        ...
        const height = this.container.offsetHeight || this.container.clientHeight || window.innerHeight;
    ...
    return () => {
      ...
      // Also ensure all children are removed in cleanup
      if (hyperspeed.current) {
